...
public class HorizontalDottedProgress extends View {
    ...
    //Radius of our dots
    private int mDotRadius = 7;

    //Radius for the larger dot
    private int mBounceDotRadius = 10;

    //the position the dots each live in
    private int mDotPosition;

    //the number of dots we have
    private int mNumberOfDots = 5;
    ...
    //ondraw draws the view at a fast interval
    @Override
